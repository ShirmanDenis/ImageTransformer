...
namespace Kontur.ImageTransformer.Filters
{
    public class SepiaFilter : IImageFilter
    {
        ...
        private static extern int Sepia(IntPtr imgData, int height, int width,  int stride, int bytesPerPixel);
        ...
        public bool Filtrate(Bitmap img)
        {
            ...
            var result = Sepia(bitmapData.Scan0, img.Height, img.Width, bitmapData.Stride, bytesPerPixel);
